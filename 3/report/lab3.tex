...
С ростом степени $\alpha$ в штрафной функции растёт число итераций и вычислений целевой функции. Для $\alpha >= 2$ оптимален rMult = 3.

Для решения методом барьерной функции оптимален выбор первой функции с параметром rMult = 2 для получения наиболее точного результата. Можно использовать метод с параметром rMult = 10. Так мы получим приближенное решение с вдвое меньшими вычислительными затратами.
